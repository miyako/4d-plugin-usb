...
bool DeviceOpen(C_LONGINT &index, C_LONGINT &vid, C_LONGINT &pid, C_LONGINT &interface){
    ...
    if(LIBUSB_READY){
        ...
        libusb_device_handle *dev_handle = libusb_open_device_with_vid_pid(LIBUSB_CTX, vid.getIntValue(), pid.getIntValue());
        ...
        if(dev_handle){
            ...
            if(available){
                ...
                if(!libusb_claim_interface(dev_handle, interface.getIntValue())){
                
                    USB_T *usb = new USB_T;
                    usb->dev = dev_handle;
                    usb->interface_number = interface.getIntValue();
